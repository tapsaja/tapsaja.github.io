...
```bash
exec "$PROGRAM_DIR"/runtime/linux/x64/runtime/bin/java -Xmx1024m
 ...
 "$PROGRAM_DIR"/lib/jnlp.jar
  ...
  "$PROGRAM_DIR"/lib/yafaray/linux/x64
   ...
   -Dcom.eteks.sweethome3d.applicationId=SweetHome3D#Portable com.eteks.sweethome3d.SweetHome3D -open "$1"
```
